class UpdateAllNcziVaccinationData < VaccinationSnapshotsBase
  include NcziClient
  ...
  def update_snapshots!
    NcziVacc
      ...
      .find_each(batch_size: 50).map do |vacc|
      place_snapshots_data = snapshots_data.fetch(vacc.external_id, [])
      UpdateNcziVaccinationSnapshots.new(vacc: vacc, data: place_snapshots_data).perform
    end.flatten
  end
